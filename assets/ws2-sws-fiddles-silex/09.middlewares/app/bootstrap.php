...
$app->register(new Knp\Provider\RepositoryServiceProvider(), array(
	'repository.repositories' => array(
		'users' => 'Ikdoeict\\Repository\\User',
		'links' => 'Ikdoeict\\Repository\\Link'
	)
));
...
// Use Monolog Service Provider — @note: Be sure to install Monolog via Composer first!
 $app->register(new Silex\Provider\MonologServiceProvider(), array(
	'monolog.logfile' => __DIR__ .  DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'app.log',
